...
export default StyleSheet.create({
	...
	/* TEXT COLORS */
	textAnimauxColor: { color: animauxColor },
	textEnvironnementColor: { color: environnementColor },
	textSocialColor: { color: socialColor },
	textCultureColor: { color: cultureColor },
	textPrimaryColor: { color: primaryColor },
	textSecondaryColor: { color: secondaryColor },
	textBlack: { color: blackColor },
	textWhite: { color: whiteColor },
	textGray: { color: grayColor },
	textError: { color: redColor },

	/* BACKGROUND COLORS */
	bgAnimauxColor: { backgroundColor: animauxColor },
	bgEnvironnementColor: { backgroundColor: environnementColor },
	bgSocialColor: { backgroundColor: socialColor },
	bgCultureColor: { backgroundColor: cultureColor },
	bgPrimaryColor: { backgroundColor: primaryColor },
	bgSecondaryColor: { backgroundColor: secondaryColor },
	bgBlack: { backgroundColor: blackColor },
	bgWhite: { backgroundColor: whiteColor },
	bgGray: { backgroundColor: grayColor },
	...
	/* BUTTONS & LINKS */
	primaryButtonColor: { backgroundColor: primaryColor },
	secondaryButtonColor: { backgroundColor: secondaryColor },
	button: {
	...
	roundedLeft: { borderTopLeftRadius: 5, borderBottomLeftRadius: 5 },
	roundedRight: { borderTopRightRadius: 5, borderBottomRightRadius: 5 },
